...
int sub_jacobi(gsl_matrix* A, gsl_vector* diag, gsl_matrix* V, int required){
...
for(int i=required;i<n;i++) gsl_vector_set(diag,i,0);

for(int i=0;i<n;i++){
	for(int j=required;j<n;j++){
